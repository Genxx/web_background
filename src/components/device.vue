<template>
  <div id="device" v-title data-title="设备管理">
    <div class="status">
      ...
      <span class="all active">全部{{numActive}}</span>
    ...
    <div class="space-info">
      <div class="space-info-t">
        <span class="fl">考拉</span>
        <p class="fr">
          <span>共1台/</span>
          <span class="col">离线1台</span>
        </p>
      </div>
      <ul class="list">
        <li>
          <div class="fl">
            <router-link tag="span" to="/deviceDetail">1号机-娃娃机117782</router-link>
            <span class="font">(1币/次)</span>
            <span class="col">离线</span>
          </div>
          <div class="fr">
            <span>信号值</span>
            <span>...</span>
