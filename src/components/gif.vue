<template>
  <div id="gif" v-title data-title="礼品设置">
    ...
    <ul class="add-kc">
      ...
      <li class="num">
        <p class="fl">增添数量</p>
        <input  name="" class="fr" v-model="num" v-on:keyup="num=num.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" style="ime-mode:disabled" onpaste="return false" type="text">
      </li>
    </ul>
    <div class="smit">
      保存
